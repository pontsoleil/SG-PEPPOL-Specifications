...
= GST accounting currency

[yellow-background]#This clause needs to be revised in line with Singapore regulation on currencies (tax total, invoice with and without gst)#
____
...
include::../../syntax/gst-currency.adoc[]
