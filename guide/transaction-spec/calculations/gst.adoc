...
====
stem:["GST category taxable amount (BT-116)" = sum("Invoice line net amounts (BT-113)")] +
stem:[+ "Document level charge amount (BT-99)" - "Document level allowance amount (BT-93)"]
====

====
stem:["GST category tax amount (BT-117)" = "GST category taxable amount (BT-116)" times ("GST rate (BT-119)" div 100)]
====
