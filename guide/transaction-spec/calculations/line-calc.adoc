...
Calculation formula:
====
stem:["Item net price" = "Item gross price (BT-148-GST)" - "Item price discount (BT-147)"]
====
...
[[lineamount-calc]]
== Invoice line net amount (BT-131-GST)
...
====
stem:["Item line net amount" = (("Item net price (BT-146-GST)" div "Item price base quantity (BT-149)")] +
