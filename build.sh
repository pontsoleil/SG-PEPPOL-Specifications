...
docker run --rm -i -v $PROJECT/target/schematron:/src -v $PROJECT/target/site/files/SG-Peppol-BIS-Billing_3-SG-Rules.sch:/target -w /src kramos/alpine-zip -r /target/SG-Peppol-BIS-Billing_3-SG-Rules-Schematron.zip .
#International rules
